      ...
      >
        ...
        <div className="hero-content text-center text-neutral-content">
          <div className="max-w-2-xl">
            ...
            <p className="mb-10 text-2xl font-medium text-right mr-20">Découvrir des perles rares.</p>
            <Link to='/city'><button className="btn btn-lg btn-block max-w-md btn-primary">Explorez maintenant !</button></Link>
          </div>
        </div>
      </div>
  );
